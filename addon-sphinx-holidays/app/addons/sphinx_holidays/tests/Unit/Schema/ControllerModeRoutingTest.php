 ...
 * sphinx_booking modes were routed, so search_poll 404ed on every poll and
...
{
    private const DISPATCHER = '/controllers/frontend/sphinx_booking.php';
    private const MODE_DIR = '/controllers/frontend/sphinx_booking';
