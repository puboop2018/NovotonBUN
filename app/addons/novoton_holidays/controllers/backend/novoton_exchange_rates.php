...
if ($mode == 'manage') {
    ...
    Tygh::$app['view']->assign('cron_password', Registry::get('addons.novoton_holidays.cron_access_key'));

    // Build cron URL for display
    $cron_url = fn_url('novoton_exchange_rates.cron', 'A');
    $cron_url .= '&cron_password=' . Registry::get('addons.novoton_holidays.cron_access_key');
    Tygh::$app['view']->assign('cron_url', $cron_url);
}
