 ...
 *
 * Replaces the scattered public debug properties that were manually synced
 * between NovotonHttpClient, ApiClientBase, and NovotonApi.
 */
class RequestDebugInfo
{
    ...
    /**
     * Create from an ApiClientBase or NovotonHttpClient instance.
     */
