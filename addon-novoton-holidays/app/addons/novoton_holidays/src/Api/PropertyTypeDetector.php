...
class PropertyTypeDetector
{
    ...
    private const KEYWORD_MAP = [
        ...
        ['pattern' => '/\bGUEST\s*HOUSES?\b/i',      'type' => 'guest_house'],
        ['pattern' => '/\bGUESTHOUSES?\b/i',         'type' => 'guest_house'],
        ['pattern' => '/\bPENSI(?:ON|UNE|UNEA)\b/i', 'type' => 'guest_house'],
        ...
        ['pattern' => '/\bBOARDING\s*HOUSES?\b/i',   'type' => 'boarding_house'],
