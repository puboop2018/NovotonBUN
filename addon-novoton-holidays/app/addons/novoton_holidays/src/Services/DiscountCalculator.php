...
class DiscountCalculator implements DiscountCalculatorInterface
{
    ...
    private readonly ReductionPercentageCalculator $reductionPercCalculator;

    public function __construct(PriceInfoParser $parser, ?callable $logger = null)
    {
        $this->parser = $parser;
        $this->logger = $logger !== null ? $logger(...) : null;
        $this->reductionPercCalculator = new ReductionPercentageCalculator($parser, $logger);
    }
    ...
    {
        return $this->reductionPercCalculator->calculateReductionPercAdditional($subtotal);
    }
    ...
    public function calculateReductionPercMarketing(
        ...
        return $this->reductionPercCalculator->calculateReductionPercMarketing($bookingDate, $checkIn, $nights, $roomId, $subtotal);
    }
