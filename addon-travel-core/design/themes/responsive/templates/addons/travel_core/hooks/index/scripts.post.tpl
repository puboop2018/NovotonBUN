...
{* Multi-room booking *}
<script src="{$config.current_location}/js/addons/addon-travel-core/multiroom-booking.js?v={$cache_ver}" defer></script>

{* Form validation scripts *}
<script src="{$config.current_location}/js/addons/addon-travel-core/dob-validation.js?v={$cache_ver}" defer></script>
<script src="{$config.current_location}/js/addons/addon-travel-core/booking-form-validation.js?v={$cache_ver}" defer></script>
